-- VC V4.09a5 (2025-09-17): CLEAN — Restore simple RAISE NOTICE messages; remove '%%' decorations.
--   Use engine.binom_p directly in Pass 6B (no temp binom_p_local).
--   Retain: ESCAPE '\' in LIKE, Pass 6A precision fix and index, and fv_interval_c season-pass rule.
