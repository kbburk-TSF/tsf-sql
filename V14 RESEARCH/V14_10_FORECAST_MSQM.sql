-- 2025-10-05: FIX — forecast_registry update: set msqm_complete = 'complete' on core completion; no other changes.
...
--              Wrapper signatures and names unchanged: engine.msqm_forecast(text), engine.msqm_forecast__core().
...
-- Entry point: engine.msqm_forecast(forecast_name TEXT) — preserved from V13
...
-- Mark completion in forecast_registry (msqm_complete -> 'complete')
BEGIN
